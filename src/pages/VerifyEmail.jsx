...
import { sendOtp, signUp } from '../services/authAPICall/authAPI';
                    ...
                    : (
                        <div className='max-w-[500px] p-4 lg:p-8'>
                            ...
                            <form onSubmit={handleOnSubmit}>
                                ...
                                />
                                <button type='submit' className='w-full bg-richblack-5 py-[12px] px-[12px] rounded-[8px] mt-6 font-medium text-richblack-900'>
                                    Verify Email
                                </button>
                            </form>
